...
[_COLEMAK] = {
  ...
  {XXXXX,      XXXXX, KC_LGUI, KC_LALT, KC_LSFT, MO(_SYM),   KC_ENT,  MO(_NAV),     KC_SPC,   XXXXX,  XXXXX,   XXXXX}
},
[_NOTED] = {
  {KC_ESC,     XXXXX, XXXXX,   XXXXX,   KC_F5,   XXXXX,      XXXXX,   KC_KP_SLASH,  XXXXX,    XXXXX,  XXXXX,   DE_MINS},
  {KC_TAB,     DE_Z,  DE_Y,    KC_U,    KC_A,    KC_Q,       KC_P,    KC_B,         KC_M,     KC_L,   KC_F,    KC_J},
  {KC_LCTL,    KC_C,  KC_S,    KC_I,    KC_E,    KC_O,       KC_D,    KC_T,         KC_N,     KC_R,   KC_H,    KC_BSPC},
  {MO(_RIGHT), KC_V,  KC_X,    DE_UDIA, DE_ADIA, DE_ODIA,    KC_W,    KC_G,         KC_COMM,  KC_DOT, KC_K,    DE_SS},
  {XXXXX,      XXXXX, KC_LGUI, KC_LALT, KC_LSFT, MO(_SYM),   KC_ENT,  MO(_NAV),     KC_SPC,   XXXXX,  XXXXX,   XXXXX}
},
[_NAV] = {
  {DF(_COLEMAK), XXXXX,   XXXXX,         XXXXX,    _____,  XXXXX,      XXXXX,   _____,   XXXXX,   XXXXX,    XXXXX, _____},
  {DF(_NOTED), DE_DEG,  KC_F7,         KC_F8,    KC_F9,  KC_F10,     KC_PGUP, KC_HOME, KC_UP,   KC_END,   _____, KC_AUDIO_VOL_UP},
